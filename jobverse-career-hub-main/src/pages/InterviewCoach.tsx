...
export default function InterviewCoach() {
  const [messages, setMessages] = useState<Message[]>([
    {
      role: 'assistant',
      content: "Hello! I'm your interview coach. I'm here to help you practice your English interview skills. Let's start with a common question: Can you tell me about yourself and your background?"
    }
  ]);
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="font-serif text-5xl font-semibold tracking-luxury text-foreground">Interview Coach</h1>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <Card className="border-border bg-gradient-card shadow-lg lg:col-span-2">
          <CardHeader>
            <CardTitle className="font-serif text-2xl font-semibold tracking-luxury text-foreground">Practice Session</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="border-border bg-gradient-card shadow-lg">
          <CardHeader>
            <CardTitle className="font-serif text-2xl font-semibold tracking-luxury text-foreground">Practice Tips</CardTitle>
          </CardHeader>
