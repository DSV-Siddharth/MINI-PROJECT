...
export default function Dashboard() {
  return (
    <div className="space-y-8">
      <div>
        <h1 className="font-serif text-5xl font-semibold tracking-luxury text-foreground">Welcome to Job-verse</h1>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        {stats.map((stat) => (
          <Card key={stat.title} className="overflow-hidden border-border bg-gradient-card shadow-md transition-all hover:shadow-lg">
            ...
            <CardContent>
              <div className="font-serif text-4xl font-semibold text-foreground">{stat.value}</div>
            </CardContent>
          </Card>
        ))}
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card className="border-border bg-gradient-card shadow-lg">
          <CardHeader>
            <CardTitle className="font-serif text-2xl font-semibold tracking-luxury text-foreground">Quick Actions</CardTitle>
          </CardHeader>
          <CardContent className="space-y-3">
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Generate your professional resume</p>
              </div>
            </a>
            <a
              href="/resume-checker"
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Analyze and improve your resume</p>
              </div>
            </a>
            <a
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Improve your English skills</p>
              </div>
            </a>
          </CardContent>
        </Card>
        ...
        <Card className="border-border bg-gradient-card shadow-lg">
          <CardHeader>
            <CardTitle className="font-serif text-2xl font-semibold tracking-luxury text-foreground">Getting Started</CardTitle>
          </CardHeader>
